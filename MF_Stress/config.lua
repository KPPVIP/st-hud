...
MFS.GetSickAt       = 100 -- only change the first value (percent player gets sick at)
MFS.MildlySickAt    = 100
MFS.ExtremelySickAt = 100 -- only change the first value (percent player vomits at)
...
MFS.StaticRelief    = 0.0 -- % stress relieved over time from events like swimming, riding bikes, etc.
MFS.StaticAdder     = 0.0 -- % stress gained over time from things like driving too fast.
MFS.CombatAdder     = 0.00 -- % stress gained while in combat
MFS.ShootingAdder   = 0.00 -- % stress gained while shooting
MFS.StressAtSpeed   = 999 -- kph
MFS.RelaxAtSpeed    = 0  -- kph